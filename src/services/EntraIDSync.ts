...
export const config = {
  cfgClientId: { domain: configDomain, key: `ClientID`, description: "The Client ID of the Azure AD App Registration used for Entra ID synchronization.", type: ConfigValueTypes.string, value: undefined, inputFormat: "^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$", outputFormat: "", editInUI: true, mandatoryForStart: true, userProfile: false },
