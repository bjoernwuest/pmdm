...
export const FunctionalPermissionNames = {
    ...
    FP_PROLONG_API_KEYS: "FP_PROLONG_API_KEYS",
    FP_CREATE_API_KEYS: "FP_CREATE_API_KEYS",
    FP_VIEW_API_KEYS: "FP_VIEW_API_KEYS",
    GRANT_FUNCTIONAL_PERMISSIONS: "FP_GRANT_FUNCTIONAL_PERMISSIONS",
    FP_READ_AUDIT_LOG: "FP_READ_AUDIT_LOG",
    FP_CLEAR_AUDIT_LOG: "FP_CLEAR_AUDIT_LOG",
    ...FPN
} as const;
