...
/**
 * Creates the UI application wired to the given database client.
 *
 ...
 */
export function createUiApp(dbClient: DBClient) {
  const app = new Elysia().decorate("dbClient", dbClient);
